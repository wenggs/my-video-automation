...
- UI operations: auto-generate lyrics (quality/model/language), retry auto-generate, auto metrics display, create job, auto-refresh, status filter, error detail expand/copy, workspace config panel
